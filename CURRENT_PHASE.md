...
| FNC-ING-002 | Seleccion explicita de hoja XLSX y limpieza visual web | In progress | Codex + Integration Steward | contrato, V0037, worker, API, web y pruebas reservados; solo datos sinteticos |
