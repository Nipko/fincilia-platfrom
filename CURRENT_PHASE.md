...
| FNC-CLS-001 | Centro diagnostico de preparacion de cierre | In progress | Codex + Integration Steward | API/web company-scoped por periodo; close_ready y ejecucion permanecen denegados |
