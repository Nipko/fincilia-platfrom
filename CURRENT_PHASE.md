...
| FNC-GAT-007 | Preflight ejecutable del entorno aislado DRG-00 | Review pending | Codex + Integration Steward | Consulta live: 0/33 foundation y 0/10 runtime; evidencia redactada/digest-only y vínculo target estricto; no mueve gates ni autoriza datos reales |
