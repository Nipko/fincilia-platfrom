...
| FNC-REC-006 | Expediente histórico direccionable de conciliación | In progress | Codex + Integration Steward | Lectura exacta company-scoped y fallback web histórico, sin reactivar datasets ni recalcular candidatos |
