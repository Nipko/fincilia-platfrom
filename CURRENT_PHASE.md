...
| FNC-FIN-002 | Sobre de costo verificable para AWS private-pilot | In progress | Codex + Integration Steward | Desglosa el plan cold por costo real, separa piso conocido de variables y bloquea apply hasta cotización regional/tope/revisión |
