...
| FNC-BET-001 | Beta cerrada sintetica con dominio propio | In progress | Codex + Integration Steward | `fincilia.com` y HTTPS activos; backup sintético íntegro; carrera de restore y reemplazo destructivo por release corregidos en código, pendientes de aplicar y verificar; E2E y revisiones siguen pendientes |
...
| FNC-IAM-001 | Inicio de sesión Google mediante Cognito | Review pending | Codex + Integration Steward | Backend `3ec2893` y web `99c9445`: Code+PKCE y resolución segura; la invitación histórica queda sustituida por FNC-IAM-004; AWS, DRG-00 y revisión independiente pendientes |
...
| FNC-IAM-004 | Alta pública definitiva con Google y aceptación legal versionada | Review pending | Codex + Integration Steward | Login no crea identidades; registro público crea sujeto, firma, owner y aceptación legal atómicos sin invitaciones; dominio/AWS y revisiones independientes pendientes |
