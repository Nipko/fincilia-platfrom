...
| FNC-PLT-011 | Laboratorio remoto AWS T1 con runtime sintetico | In progress | Codex + Integration Steward | Host unico t3.small, SSM-only, EBS cifrado, maximo 4h y stack completo sintetico; contrato/IaC en construccion |
