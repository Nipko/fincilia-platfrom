...
| FNC-GAT-005 | Readiness del piloto privado con datos reales | In progress | Codex + Integration Steward | 15 blockers: tres controles DRG-01 (cross-tenant, ingreso, canales) ya adjudicados; entorno protegido, supply, restore/derechos y revisiones humanas siguen pendientes |
| FNC-GAT-006 | Evidencia adjudicada de aislamiento, ingreso y canales DRG-01 | Review pending | Codex + Integration Steward | 90 pruebas PostgreSQL/MinIO; D01-XTENANT, D01-INGRESS y D01-CHANNELS pasan con fuentes ligadas por SHA-256 |
