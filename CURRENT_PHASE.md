...
| FNC-GAT-005 | Readiness del piloto privado con datos reales | In progress | Codex + Integration Steward | 13 blockers: supply chain, cross-tenant, ingreso, canales y derechos/incidente adjudicados; entorno protegido, identidad, cloud, restore target y revisiones humanas siguen pendientes |
...
| FNC-UAT-003 | Evidencia verificable del borde HTTPS UAT | Review pending | Codex + Integration Steward | TLS 1.3, redirección, HSTS y 10 rutas públicas verificadas read-only; CI `33698034556` verde y revisiones pendientes |
...
| FNC-LEG-002 | Centro legal público Fincilia/Parallext LLC | Review pending | Codex + Integration Steward | Centro legal inglés con URLs canónicas inglesas y redirecciones permanentes desde las rutas anteriores; aceptación `terms/privacy-2026-09-03-en` preparada por V0057 sin reescribir historial; revisión independiente Legal/Privacy/Security/Product/Accessibility pendiente |
