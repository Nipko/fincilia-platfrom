...
| FNC-SUP-002 | Attestation verificable del candidato | Review pending | Codex + Integration Steward | Run `33256843904`: bundle, SLSA y SPDX firmados por OIDC y revalidados fuera del runner; Security/QA pendientes |
...
| FNC-GAT-005 | Readiness del piloto privado con datos reales | In progress | Codex + Integration Steward | DRG-00: inventario/borrado/drill y 3/4 claims supply pasan; entorno real, origen supply y 4 controles humanos siguen pendientes |
...
| FNC-IAM-003 | Cierre operativo de identidad administrada | In progress | Codex + Integration Steward | Logout Cognito, limpieza de sesión y operación de invitaciones; activación real permanece bloqueada por DRG-00 |
