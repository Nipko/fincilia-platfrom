...
| FNC-REC-002 | Propuesta y decision humana de conciliacion sin efecto financiero | In progress | Codex + Integration Steward | ledger append-only, SoD, idempotencia, API/web y pruebas |
