...
| FNC-LEG-002 | Centro legal público Fincilia/Parallext.com | Review pending | Codex + Integration Steward | Centro público y contactos `@fincilia.com` verificados en CI `33602394254`; contenido sigue sujeto a revisión independiente Legal/Privacy/Security/Product/Accessibility |
