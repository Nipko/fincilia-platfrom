...
| FNC-CLS-006 | Cierre y reapertura real de periodo | In progress | Codex + Integration Steward | Snapshot append-only, bloqueo DB, reapertura SoD, API/web y pruebas; solo sintético y ADR-035/revisión independiente pendientes |
| FNC-ING-006 | PDF seguro y OCR desacoplado | Proposed | Codex + Integration Steward | Parser local aislado primero; OCR externo y datos reales permanecen desactivados |
| FNC-NTF-001 | Notificaciones externas verificables | Proposed | Codex + Integration Steward | Preferencias, outbox, historial y adaptadores; proveedor/remitente al final |
| FNC-BIL-001 | Planes, entitlements y facturación | Proposed | Codex + Integration Steward | Tres planes y billing provider-neutral; pagos reales y precios definitivos al final |
