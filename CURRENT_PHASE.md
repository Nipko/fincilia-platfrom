...
| FNC-UAT-002 | Aceptación integral desechable desde esquema vacío | In progress | Codex + Integration Steward | Alta sintética desde base vacía, regresión sembrada Chromium/Axe y limpieza entre fases; implementación y evidencia en curso |
...
| FNC-SEC-006 | Endurecimiento HTTP verificable para UAT | Ready | Codex + Integration Steward | Cabeceras API/web y pruebas sin asumir TLS local ni romper Google OAuth |
| FNC-REC-007 | Productividad segura del explorador de conciliación | Ready | Codex + Integration Steward | Filtro determinista de referencia sin score, tolerancia, auto-match ni efecto financiero |
| FNC-ADM-002 | Diagnóstico operativo agregado del plano de control | Ready | Codex + Integration Steward | Conteos allowlisted sin acceso transversal a datos financieros; V0052 y consumidores pendientes |
