...
| FNC-CLN-002 | Aplicacion reproducible de correcciones aprobadas | In progress | Codex + Integration Steward | V0023, version derivada, manifest, linaje digest-only, API/web y PostgreSQL sintetico |
