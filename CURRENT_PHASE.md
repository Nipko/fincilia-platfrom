...
| FNC-SUP-004 | Cobertura cerrada de fuentes de imágenes | In progress | Codex + Integration Steward | Extractor fail-closed de `COPY`, árboles disjuntos y regeneración de candidato/evidencia en curso; revisión independiente pendiente |
...
| FNC-GAT-005 | Readiness del piloto privado con datos reales | In progress | Codex + Integration Steward | Candidato firmado `37df2db`, run `33804614558`, procedencia y SBOM revalidados fuera del runner; entorno protegido, identidad, restore target y revisiones humanas siguen pendientes |
