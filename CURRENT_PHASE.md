...
| FNC-GAT-006 | Evidencia adjudicada de aislamiento, ingreso y canales DRG-01 | Review pending | Codex + Integration Steward | 90 pruebas PostgreSQL/MinIO; D01-XTENANT, D01-INGRESS y D01-CHANNELS pasan con fuentes ligadas por SHA-256 canónico LF/CRLF |
| FNC-PRV-004 | Ensayo ejecutable de derechos e incidente previo a DRG-01 | Review pending | Codex + Integration Steward | 12 pasos sintéticos y digest reproducible LF/CRLF: alcance, revocación, tombstone, restore cerrado y post-revisión; Legal pendiente |
