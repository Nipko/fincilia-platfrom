...
| FNC-CLS-005 | Expediente de revision previa al cierre | In progress | Codex + Integration Steward | manifestacion digest-only versionada, asignacion y decision append-only con SoD; sin snapshot ni efecto financiero |
