...
| FNC-SUP-003 | Publicación OIDC de imágenes inmutables al piloto privado | In progress | Codex + Integration Steward | Confianza GitHub→AWS, rol ECR mínimo, publicador manual y manifiesto por digest; sin apply, despliegue ni datos reales |
