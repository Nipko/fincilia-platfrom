...
| FNC-UAT-003 | Evidencia verificable del borde HTTPS UAT | Review pending | Codex + Integration Steward | TLS 1.3, redirección, HSTS y 10 rutas públicas verificadas read-only; Security/Platform/QA pendientes |
