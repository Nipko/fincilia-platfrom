...
| FNC-UAT-003 | Evidencia verificable del borde HTTPS UAT | In progress | Codex + Integration Steward | Sonda read-only de TLS, redirección y cabeceras públicas; no envía identidad ni payload |
