...
| FNC-IAM-001 | Inicio de sesión Google mediante Cognito | In progress | Codex + Integration Steward | Code+PKCE y scopes mínimos; activación real bloqueada por DRG-00 y configuración externa |
