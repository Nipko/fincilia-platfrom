...
| FNC-SUP-002 | Attestation verificable del candidato | In progress | Codex + Integration Steward | Bundle determinista, procedencia SLSA y SBOM firmados por OIDC; activacion externa y revision Security/QA pendientes |
...
| FNC-GAT-005 | Readiness del piloto privado con datos reales | In progress | Codex + Integration Steward | DRG-00: inventario/borrado/drill pasan; entorno real, supply chain y 4 controles humanos siguen pendientes |
