...
| FNC-IAM-002 | Centro de cuenta y recorrido de identidad coherente | In progress | Codex + Integration Steward | `/me`, cuenta, sesión, empresas y roles sin exponer identidad externa; DRG-00 no cambia |
| FNC-ACC-001 | Recorrido contable guiado de punta a punta | In progress | Codex + Integration Steward | Orquestación web desde configuración hasta expediente previo al cierre sobre capacidades existentes |
| FNC-UX-002 | Shell SaaS premium y sistema visual web v2 | In progress | Codex + Integration Steward | Navegación jerárquica, design tokens, motion reducido, responsive y accesibilidad sin dependencia nueva |
