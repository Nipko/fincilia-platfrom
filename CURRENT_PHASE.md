...
| FNC-GAT-007 | Preflight ejecutable del entorno aislado DRG-00 | In progress | Codex + Integration Steward | Inventario remoto mínimo y fail-closed implementado; consulta live AWS y revisiones independientes pendientes; no mueve gates ni autoriza datos reales |
