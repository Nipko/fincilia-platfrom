...
| FNC-GAT-007 | Preflight ejecutable del entorno aislado DRG-00 | Review pending | Codex + Integration Steward | Catálogo único 36/11; consulta live: foundation 32/36 y runtime 0/11, RDS ausente y cero NAT; no mueve gates ni autoriza datos reales |
...
| FNC-PLT-015 | Materialización segura de la foundation private-pilot AWS | In progress | Codex + Integration Steward | 32/36 recursos mínimos presentes y 0/11 runtime; preflight fail-closed confirma `FREE/ACTIVE`, RDS ausente y plan frío 7 altas/5 cambios/0 borrados; upgrade directo explícito pendiente |
