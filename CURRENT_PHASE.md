...
| FNC-ING-003 | Ingesta ligada a fuente y centro historico de documentos | In progress | Codex + Integration Steward | V0038, API, historico web y pruebas reservados; solo datos sinteticos |
