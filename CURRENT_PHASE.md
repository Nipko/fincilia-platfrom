...
| FNC-SUP-001 | Baseline ejecutable de cadena de suministro | Claimed | Claude | docs/security/SUPPLY_CHAIN_BASELINE.md, supply-chain.json, tools/supply_chain, handoff |
| FNC-DB-002 | Spike PostgreSQL de migraciones SQL-first | Claimed | Claude | docs/database/MIGRATION_SPIKE.md, migration-spike.json, spikes/FNC-DB-002, tools/migration_spike, handoff |
| FNC-PLT-007 | CLI segura de desarrollo local | Claimed | Claude | docs/platform/DEVELOPER_CLI.md, developer-cli.json, tools/dev_cli, handoff |
| FNC-GAT-003 | Agregador ejecutable de readiness S1 | Claimed | Claude | docs/implementation/S1_READINESS_REPORT.md, s1-readiness.json, tools/s1_readiness, handoff |
...
| 1 | FNC-SUP-001 Baseline de supply chain | FNC-PLT-003, FNC-QA-005 | Claimed by Claude |
| 1 | FNC-DB-002 Spike de invariantes de migración | FNC-DB-001, FNC-PLT-002 | Claimed by Claude |
| 1 | FNC-PLT-007 CLI de desarrollo | FNC-PLT-002/003, FNC-QA-004/005 | Claimed by Claude |
| 1 | FNC-GAT-003 Readiness S1 ejecutable | FNC-ARC-006, FNC-QA-004/005, FNC-SUP-001, FNC-DB-002 | Claimed by Claude; gate sigue not_met |
