...
| FNC-GAT-007 | Preflight ejecutable del entorno aislado DRG-00 | Review pending | Codex + Integration Steward | Consulta live: 0/33 foundation y 0/10 runtime; plan cold digest-only 142 create/11 read/0 update/0 delete, sin apply; no mueve gates ni autoriza datos reales |
...
| FNC-PLT-015 | Materialización segura de la foundation private-pilot AWS | In progress | Codex + Integration Steward | 32/33 recursos mínimos presentes en modo cold, cero runtime; RDS bloqueado por límite de retención del plan gratuito y no se redujo el control de 14 días |
