...
| A-02 | Proveedor, región, celdas y transmisión | Paquete FNC-ARC-003 en review; selección humana abierta |
...
| FNC-DOM-004 | Evidencia, dedupe e idempotencia | 5 capas, 12 escenarios y 33 pruebas PASS; review pending |
| FNC-PRV-001 | Privacidad, retención y borrado | 25 actividades, 8 gates y 53 pruebas PASS; review pending |
| FNC-ARC-004 | Eventos, outbox, retries y DLQ | 5 clases de trabajo, 20 escenarios y 47 pruebas PASS; review pending |
| FNC-ARC-005 | Conectores y fallback permanente | 7 gates, 15 escenarios y 35 pruebas PASS; review pending |
| FNC-PLT-002 | Compose local del producto | PostgreSQL mínimo y lifecycle entregados; review pending |
