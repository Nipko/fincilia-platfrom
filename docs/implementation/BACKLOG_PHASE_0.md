...
| FNC-CLS-004 | A5/A6 | CLS-001, CLS-002, CLS-003 | In progress | Preparacion de cierre integra cobertura de statements por cuenta/periodo y distingue evidencia lista para revision, sin ejecutar ni certificar cierre |
