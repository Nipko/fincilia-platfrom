...
| FNC-MAP-001 | A4/A5 | ING-003, API-001 | Review pending | Una version de mapeo solo puede usar evidencia recibida por la misma fuente inmutable; guard PostgreSQL y negativa neutral API; CI `33601151681` verde |
| FNC-MAP-002 | A4/A5 | MAP-001, API-001 | Review pending | Versiones de mapeo inmutables y maquina `draft -> validated -> superseded` aplicada por PostgreSQL; CI `33601151681` verde |
...
| FNC-WEB-005 | A6 | WEB-004, GAT-008, ING-006, NTF-001, DQ-001, BIL-001 | Review pending | Superficies web completas para capacidades actuales; alta vacía, 44 Chromium y 27 Axe integrales verdes; proveedores y datos reales siguen fuera |
...
| FNC-REC-007 | A5/A6 | REC-001, REC-006 | Review pending | Filtro server-side all/matching/different, URL y paginación probadas; sin score, tolerancia, auto-match ni efecto financiero |
...
| FNC-DQ-002 | A5/A6 | DQ-001, WEB-005 | Review pending | Cinco senales avanzadas y una regla compuesta deterministas, explicables y verificadas E2E; solo priorizan revision humana y no afirman fraude |
...
| FNC-PLT-017 | A2/A3/A4/A5 | PLT-016, PLT-015, SUP-003 | Review pending | Ciclo warm→secretos→bootstrap→57 migraciones→cold demostrado en AWS; capacidad cero, sin semilla ni datos reales; revisión independiente pendiente |
...
| FNC-LEG-003 | A2/A3 | LEG-001, LEG-002, ARC-003, GAT-005 | Review pending | Registro versionado de cinco proveedores por plano, datos y límites; contrato y divulgación pública ejecutables; A-02/DRG permanecen cerrados hasta revisión independiente |
...
| FNC-ING-007 | A4/A5/A6 | ING-006, ARC-001 | Review pending | OCR local aislado, derivado determinista, inspección integral y localizador por bloque verificados; sin egress ni datos reales |
...
| FNC-BIL-002 | A2/A4/A5/A6 | BIL-001, IAM-004, SEC-001 | Review pending | Checkout/Portal Stripe, webhook firmado serializado y activación AWS fail-closed; apagado sin precios ni secretos, revisión/aceptación pendientes |
| FNC-GAT-008 | A1/A6 | WEB-004, ACC-001, IAM-004 | Review pending | Inventario ejecutable de 12 dominios: 100 % implementación, 62 % aceptación sintética y 30 % operabilidad productiva; mobile excluido |
...
- Auto-match o informes financieros certificados.
- Parser universal, contraseñas PDF u OCR externo sin AI Gateway/DPA.
- Alertas que declaren fraude.
- IA externa, entrenamiento o Needle.
- Aplicación móvil productiva.
- Precios definitivos o cobros reales sin proveedor/configuración aprobados.
