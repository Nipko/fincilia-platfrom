...
| FNC-REC-001 | A5/A6 | DOM-003, DOM-004, WEB-003, QA-006 | In progress | Exploración sintética read-only de candidatos explicados; sin decisión, auto-match ni cierre |
