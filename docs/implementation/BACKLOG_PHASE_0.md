...
| FNC-CLS-005 | A5/A6 | CLS-004, LIN-001, SEC-001 | In progress | Expediente digest-only, versionado y append-only para revision previa con asignacion, SoD y drift; sin snapshot, certificacion ni cierre |
