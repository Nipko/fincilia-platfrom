...
| FNC-ING-007 | A4/A5/A6 | ING-006, ARC-001 | In progress | OCR local aislado, derivado determinista y localizador por bloque; sin egress ni datos reales |
...
| FNC-GAT-008 | A1/A6 | WEB-004, ACC-001, IAM-004 | Review pending | Inventario ejecutable de 12 dominios: 93 % implementación, 62 % aceptación sintética y 30 % operabilidad productiva; mobile excluido |
