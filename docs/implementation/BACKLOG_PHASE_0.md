...
| FNC-PLT-017 | A2/A3/A4/A5 | PLT-016, PLT-015, SUP-003 | In progress | Ejecución temporal warm→secretos→bootstrap→migraciones→cold, siempre sin semilla, servicios activos ni datos reales |
