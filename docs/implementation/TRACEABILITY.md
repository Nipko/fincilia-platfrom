...
| REQ-FNC-090-DRG00-TECHNICAL | §0.4, §48; SEC-003 | PLT-004, DAT-003, PRV-003, QA-001, GAT-005 | laboratorio sin red, inventario hash-chain, disposal/restore y evidencia `FNC-QA-001.json` | 29 unitarias focales, 2 sondas Docker y LAB-T01..T12; digest de evidencia validado | DRG-00 | Review pending; inventario, borrado y drill pasan; entorno real, supply chain y cuatro controles humanos siguen pendientes |
