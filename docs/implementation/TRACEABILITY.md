...
| REQ-FNC-073-RELEASE-CANDIDATE | §18, §26, §29, §32, §36, §54 | REL-001 | Bundle SPDX y manifiesto de candidato, observabilidad allowlisted y workflow manual | `tools.release_candidate`, API/worker unitarias, build y smoke | DRG-00 | In progress; no habilita producción, firma, procedencia ni datos reales |
