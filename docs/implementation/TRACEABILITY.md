...
| REQ-FNC-067-SUPPLY-CHAIN | §29, §54 | SUP-001, SUP-002 | Inventario de pins, SPDX agregado y attestations OIDC/Sigstore | 80 supply-chain, 27 release y run `33256843904` | DRG-00 / TM-005 | Review pending; SBOM/firma/procedencia pasan, origen independiente y monitores OCI abiertos |
...
| REQ-FNC-073-RELEASE-CANDIDATE | §18, §26, §29, §32, §36, §54 | REL-001, SUP-002 | Bundle SPDX agregado, archivo determinista, observabilidad allowlisted y attestations externas | 27 release, 6 observabilidad, 156 API, 20 worker; release `33256843904` | DRG-00 | Review pending; firma y procedencia del candidato verificadas, sin publicar imágenes, producción ni datos reales |
...
| REQ-FNC-085-PRIVATE-REAL-PILOT | §0.4 DRG-00/01; ADR-032 Proposed | GAT-005, PLT-012, SEC-003, REL-001 | `drg01-readiness.json`, validador fail-closed y arquitectura separada propuesta | 10 pruebas adversariales; 21 blockers tipados por gate/owner | DRG-00 / DRG-01 | In progress; alcance founder-first acotado, cero datos reales autorizados hasta completar evidencias y revisiones independientes |
...
| REQ-FNC-092-PUBLIC-GOOGLE-REGISTRATION | ADR-012; IAM-001/002/003, ONB-001, LEG-002 | IAM-004 | V0043, `public_google`, login/registro separados, aceptaciones legales versionadas y runbook Google | 258 web, 182 API, 391 PostgreSQL, migration/runtime/private-pilot validators y build | DRG-00 | Review pending; implementación sintética completa, dominio/Google/AWS y revisiones Security/Privacy-Legal/Database/UX/QA pendientes; no autoriza datos reales |
...
| REQ-FNC-094-RECONCILIATION-PRODUCTIVITY | ADR-027; REC-001/006 | REC-007 | `reference_mode` server-side, contrato API y estado URL/paginación web | unitarias, API, PostgreSQL y dos regresiones UAT completas | S1-READY | Review pending; filtro determinista sin score, tolerancia, auto-match ni efecto financiero |
