...
def validate_sources(sources: str | None = None) -> list[str]:
    ...
    required = (
        ...
        'limit_req_zone $auth_write_key zone=auth:10m rate=10r/m;',
        ...
        'fincilia/t0/{component}@sha256:',
        'require_recent_object',
        "'manifest.sha256' 93600 'backup'",
        "'.json' 691200 'restore-check'",
        'public_https_smoke',
        'FINCILIA_UAT_DOMAIN=',
        'deployment-evidence/uat/',
        '"deployment-evidence/uat/*"',
        '"public_https_smoke":true',
        'RestoreCheckSuccess',
        'fincilia-uat-reset.lock',
    ...
    forbidden = (
        ...
        'ports: ["6379:',
        'ports: ["9000:',
        'limit_req_zone $binary_remote_addr zone=auth:',
